var substringMatcher = function (strs) {
    return function findMatches(q, cb) {
        ...
        // iterate through the pool of strings and for any string that contains the
        // substring `q`, add it to the `matches` array
...
// ---------- Bloodhound ---------- constructs the suggestion engine
