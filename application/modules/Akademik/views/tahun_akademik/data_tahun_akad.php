...
<div id="Addtahun" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="AddtahunLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?= site_url('administrator/tahun-akademik/insert') ?>" method="post">
...
<?php else : ?>
    <?php $i = 1;
    foreach ($data->result() as $item) : ?>
        <div id="Edittahun<?= $item->id_tahun; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="EdittahunLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= site_url('administrator/tahun-akademik/update') ?>" method="post">
                        <div class="modal-body row">
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Kode Tahun Akademik</label>
                                <div class="col-md-12">
                                    <input type="number" class="form-control" name="kode_tahun" value="<?= $item->kode_tahun_akademik; ?>" placeholder="Enter Numeric value only" required="required">
                                    <input hidden class="form-control" name="id_tahun" value="<?= $item->id_tahun; ?>" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Nama Tahun Akademik</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="nama_tahun" value="<?= $item->nama_tahun_akademik; ?>" placeholder="type nama tahun akademik" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Semester</label>
