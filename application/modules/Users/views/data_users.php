            ...
            <div class="card card-outline-info">
                <div class="nduwur rounded-top py-3 px-3">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="ml-auto">
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#Addusers" class="btn btn-warning btn-sm text-white">+ Create
                                <?= $title ?></a>
                        </div>
                    </div>
                </div>
...
<div id="Addusers" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="AddusersLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?= site_url('administrator/data-users/insert') ?>" method="post">
                <div class="modal-body row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-md-12">
                            <input type="email" class="form-control" name="email_users" value="" placeholder="Enter Email" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else : ?>
                                <?php foreach ($ulevel->result() as $lev) : ?>
                                    <input type="checkbox" name="level[]" id="mds<?= $lev->id_level; ?>" class="chk-col-red" value="<?= $lev->id_level; ?>" />
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-12">
                            <input type="password" class="form-control" name="Conf_pass" value="" placeholder="Repeat Enter Password" required="required">
                        </div>
                    </div>
        ...
        <div id="Editusers<?= $item->id_users; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="EditusersLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= site_url('administrator/data-users/update') ?>" method="post">
                        <div class="modal-body row">
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Nama Users</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="nama_users" value="<?= $item->nama_users; ?>" placeholder="Enter Name of Users" required="required">
                                    <input type="text" class="form-control" name="id_users" value="<?= $item->id_users; ?>" placeholder="Enter Name of Users" required="required" hidden>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Username</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="username" value="<?= $item->username; ?>" placeholder="Enter Username" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Email</label>
                                <div class="col-md-12">
                                    <input type="email" class="form-control" name="email_users" value="<?= $item->email_users; ?>" placeholder="Enter Email" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="col-md-12">Users Level</label>
                                <div class="col-md-12">
                                    ...
                                    <?php else : ?>
                                        <?php $i = 1;
                                        foreach ($ulevel->result() as $lev) : ?>
                                            <?php $le = $this->db->where('id_users', $item->id_users)->where('id_level', $lev->id_level)->get('tb_users_levels'); ?>
                                            <input type="checkbox" name="level[]" id="mdu<?= $lev->id_level; ?><?= $item->id_users ?>" class="chk-col-red" value="<?= $lev->id_level; ?>" <?= $le->num_rows() > 0 ? 'checked' : ' '; ?> />
                            ...
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Password</label>
                                <div class="col-md-12">
                                    <input type="password" class="form-control" name="password" value="<?= $item->pass_users; ?>" placeholder="Enter Password" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Repeat Password</label>
