            ...
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                        ...
                        <span class="hide-menu">Ui Elements
                            <span class="label label-rouded label-danger pull-right">25</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a href="form-bootstrap-validation.html">Form Bootstrap Validation</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li>
                            <a href="widget-apps.html">Data Widgets</a>
                        </li>
                        <li>
                            <a href="widget-data.html">Statestic Widgets</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                        ...
                        <span class="hide-menu">Sample Pages
                            <span class="label label-rouded label-success pull-right">25</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li>
