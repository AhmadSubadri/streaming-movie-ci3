                            ...
                            <tbody>
                                ...
                                foreach ($data->result() as $item) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#EditMahasiswa<?= $item->id; ?>" data-id="<?= $item->id; ?>" class="btn btn-sm btn-outline-warning">
                                                <i class="fa fa-pencil"></i>
                                                Edit</a>
                                            <button data-id="<?= $item->id; ?>" class="detail-mahasiswa btn btn-sm btn-outline-info">
                                                <i class="fa fa-eye"></i>
                                                Detail</button>
                                        </td>
                                    </tr>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" name="jenis_kelamin_mahasiswa" readonly disabled>
                                    ...
                                    <option value="Laki-Laki" <?= ($item->jenis_kelamin_mahasiswa == "Laki-laki") ? 'selected' : ''; ?>>Laki-Laki</option>
                                    <option value="Perempuan" <?= ($item->jenis_kelamin_mahasiswa == "Perempuan") ? 'selected' : ''; ?>>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
