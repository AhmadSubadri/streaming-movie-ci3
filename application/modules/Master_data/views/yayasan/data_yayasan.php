                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            value="<?= isset($data) ? $data->kode_badan_hukum : '';?>"
                                            placeholder="1234">
                                        <input
                                            type="text"
                                            id="id"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            value="<?= isset($data) ? $data->nama_badan_hukum : '';?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            placeholder="0812***"
                                            value="<?= isset($data) ? $data->telepon_yayasan : '';?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            name="fax_yayasan"
                                            class="form-control"
                                            value="<?= isset($data) ? $data->fax_yayasan : '' ;?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input
                                                ...
                                                value="<?= isset($data) ? $data->email_yayasan : '';?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input
                                                ...
                                                value="<?= isset($data) ? $data->website_yayasan : '';?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input
                                                ...
                                                value="<?= isset($data) ? $data->kota_yayasan : '';?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input
                                                ...
                                                value="<?= isset($data) ? $data->pos_yayasan : '';?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input
                                                ...
                                                name="awal_berdiri"
                                                placeholder="Enter kode pos"
                                                value="<?= isset($data) ? $data->awal_berdiri : '';?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                                    <i class="mdi mdi-code-tags-check"></i>
                                                </span>
