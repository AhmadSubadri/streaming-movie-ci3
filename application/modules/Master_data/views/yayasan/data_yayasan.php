    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <form action="<?= site_url('administrator/data-yayasan/insert') ?>" method="post">
                        <div class="form-body">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="kode_badan_hukum" name="kode_badan_hukum" class="form-control" value="<?= isset($data) ? $data->kode_badan_hukum : ''; ?>" placeholder="1234">
                                        <input type="text" id="id" name="id" class="form-control" value="<?= isset($data) ? $data->id : ''; ?>" placeholder="1234" hidden="hidden">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_badan_hukum" name="nama_badan_hukum" class="form-control" value="<?= isset($data) ? $data->nama_badan_hukum : ''; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="telepon_yayasan" name="telepon_yayasan" class="form-control" placeholder="0812***" value="<?= isset($data) ? $data->telepon_yayasan : ''; ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="email" class="form-control" id="email_yayasan" name="email_yayasan" placeholder="Enter email" value="<?= isset($data) ? $data->email_yayasan : ''; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="link" class="form-control" id="website_yayasan" name="website_yayasan" placeholder="Enter website" value="<?= isset($data) ? $data->website_yayasan : ''; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="kota_yayasan" name="kota_yayasan" placeholder="Enter kota" value="<?= isset($data) ? $data->kota_yayasan : ''; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="pos_yayasan" name="pos_yayasan" placeholder="Enter kode pos" value="<?= isset($data) ? $data->pos_yayasan : ''; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="date" class="form-control" id="awal_berdiri" name="awal_berdiri" placeholder="Enter kode pos" value="<?= isset($data) ? $data->awal_berdiri : ''; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">
                                                    <i class="mdi mdi-code-tags-check"></i>
                                                </span>
