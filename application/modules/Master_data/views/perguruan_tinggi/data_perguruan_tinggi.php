    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('administrator/data-perguruan-tinggi/insert'); ?>
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kode_pt" name="kode_pt" class="form-control" value="<?= isset($data) ? $data->kode_pt : ''; ?>" placeholder="1234">
                                    <input type="text" id="id_pt" name="id_pt" class="form-control" value="<?= isset($data) ? $data->id_pt : ''; ?>" placeholder="1234" hidden="hidden">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control" id="email_pt" name="email_pt" placeholder="Enter email" value="<?= isset($data) ? $data->email_pt : ''; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_pt" name="nama_pt" class="form-control" value="<?= isset($data) ? $data->nama_pt : ''; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="awal_berdiri_pt" name="awal_berdiri_pt" placeholder="Enter kode pos" value="<?= isset($data) ? $data->awal_berdiri_pt : ''; ?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="link" class="form-control" id="website_pt" name="website_pt" placeholder="Enter website" value="<?= isset($data) ? $data->website_pt : ''; ?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="no_telepon_pt" name="no_telepon_pt" placeholder="Enter telpon" value="<?= isset($data) ? $data->no_telepon_pt : ''; ?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="fax_pt" name="fax_pt" placeholder="Enter fax" value="<?= isset($data) ? $data->fax_pt : ''; ?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="kode_pos_pt" name="kode_pos_pt" placeholder="Enter kode pos" value="<?= isset($data) ? $data->kode_pos_pt : ''; ?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
                                                <i class="mdi mdi-code-tags-check"></i>
                                            </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="logo_pt" name="logo_pt" aria-describedby="logo_pt">
                                ...
                                <?php if (empty($data->logo_pt)) : ?>
                                    <img src="<?= base_url('uploads/no_image.jpg'); ?>" width="150px" height="150px" />
                                <?php else : ?>
                                    <img src="<?= base_url('uploads/' . $data->logo_pt); ?>" width="200px" height="200px" class="img-fluid" />
                                <?php endif; ?>
                            </div>
                            <!--/span-->
                        </div>
