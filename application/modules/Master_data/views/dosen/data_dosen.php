            ...
            <div class="card card-outline-info">
                <div class="nduwur rounded-top py-3 px-3">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="ml-auto">
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#Adddosen" class="btn-warning btn-sm">
...
<!-- Modal Add dosen -->
<div id="Adddosen" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="AdddosenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?= site_url('administrator/data-dosen/insert') ?>" method="post">
                <div class="modal-body row">
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">NIP Dosen</label>
                        <div class="col-md-12">
                            <input type="number" class="form-control" name="nip" value="" placeholder="Enter numeric value" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">Nama dosen</label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="nama_dosen" value="" placeholder="type name lecturer" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="tempat_lahir_dosen" value="" placeholder="type place of birth" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">Tanggal Lahir</label>
                        <div class="col-md-12">
                            <input type="date" class="form-control" name="tanggal_lahir_dosen" value="" placeholder="type date of birth" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">Alamat</label>
                        <div class="col-md-12">
                            <textarea class="form-control" name="alamat_dosen" placeholder="type address" required="required"></textarea>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">Kode Pos</label>
                        <div class="col-md-12">
                            <input type="number" class="form-control" name="kode_pos_dosen" value="" placeholder="type pos code" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">Telephon</label>
                        <div class="col-md-12">
                            <input type="number" class="form-control" name="no_telepon_dosen" value="" placeholder="type phone number" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-md-12">Email</label>
                        <div class="col-md-12">
                            <input type="email" class="form-control" name="email_dosen" value="" placeholder="type email valid" required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
        ...
        <div id="Editdosen<?= $item->iddosen; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="EditdosenLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= site_url('administrator/data-dosen/update') ?>" method="post">
                        <div class="modal-body row">
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">NIP Dosen</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Nama dosen</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="nama_dosen" value="<?= $item->nama_dosen; ?>" placeholder="type name lecturer" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Jenis Kelamin</label>
                            ...
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Tempat Lahir</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="tempat_lahir_dosen" value="<?= $item->tempat_lahir_dosen; ?>" placeholder="type place of birth" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Tanggal Lahir</label>
                                <div class="col-md-12">
                                    <input type="date" class="form-control" name="tanggal_lahir_dosen" value="<?= $item->tanggal_lahir_dosen; ?>" placeholder="type date of birth" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Alamat</label>
                                <div class="col-md-12">
                                    <textarea class="form-control" name="alamat_dosen" placeholder="type address" required="required"><?= $item->alamat_dosen; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Kode Pos</label>
                                <div class="col-md-12">
                                    <input type="number" class="form-control" name="kode_pos_dosen" value="<?= $item->kode_pos_dosen; ?>" placeholder="type pos code" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Telephon</label>
                                <div class="col-md-12">
                                    <input type="number" class="form-control" name="no_telepon_dosen" value="<?= $item->no_telepon_dosen; ?>" placeholder="type phone number" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Email</label>
                                <div class="col-md-12">
                                    <input type="email" class="form-control" name="email_dosen" value="<?= $item->email_dosen; ?>" placeholder="type email valid" required="required">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="col-md-12">Kode PT</label>
